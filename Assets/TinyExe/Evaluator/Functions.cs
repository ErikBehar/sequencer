...
namespace TinyExe
{
		public class Functions : Dictionary<string, Function>
		{
				...
				public void InitDefaults ()
				{
						...
						this.Add ("about", new StaticFunction ("About", delegate(object[] ps) {
								return "@TinyExe - a Tiny Expression Evaluator v1.0\r\nby Herre Kuijpers - Copyright © 2011 under the CPOL license";
						}, 0, 0));
						...
						this.Add ("abs", new StaticFunction ("Abs", delegate(object[] ps) {
								return Math.Abs (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("acos", new StaticFunction ("Acos", delegate(object[] ps) {
								return Math.Acos (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("asin", new StaticFunction ("Asin", delegate(object[] ps) {
								return Math.Asin (Convert.ToDouble (ps [0]));
						}, 1, 1));

						this.Add ("atan", new StaticFunction ("Atan", delegate(object[] ps) {
								return Math.Atan (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("atan2", new StaticFunction ("Atan2", delegate(object[] ps) {
								return Math.Atan2 (Convert.ToDouble (ps [0]), Convert.ToDouble (ps [1]));
						}, 2, 2));
						this.Add ("ceiling", new StaticFunction ("Ceiling", delegate(object[] ps) {
								return Math.Ceiling (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("cos", new StaticFunction ("Cos", delegate(object[] ps) {
								return Math.Cos (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("cosh", new StaticFunction ("Cosh", delegate(object[] ps) {
								return Math.Cosh (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("exp", new StaticFunction ("Exp", delegate(object[] ps) {
								return Math.Exp (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("int", new StaticFunction ("int", delegate(object[] ps) {
								return (int)Math.Floor (Convert.ToDouble (ps [0]));
						}, 1, 1));
						...
						this.Add ("floor", new StaticFunction ("Floor", delegate(object[] ps) {
								return Math.Floor (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("log", new StaticFunction ("Log", Log, 1, 2)); // log allows 1 or 2 parameters
						this.Add ("ln", new StaticFunction ("Ln", delegate(object[] ps) {
								return Math.Log (Convert.ToDouble (ps [0]));
						}, 1, 1));
						...
						this.Add ("sign", new StaticFunction ("Sign", delegate(object[] ps) {
								return Math.Sign (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("sin", new StaticFunction ("Sin", delegate(object[] ps) {
								return Math.Sin (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("sinh", new StaticFunction ("Sinh", delegate(object[] ps) {
								return Math.Sinh (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("sqr", new StaticFunction ("Sqr", delegate(object[] ps) {
								return Convert.ToDouble (ps [0]) * Convert.ToDouble (ps [0]);
						}, 1, 1));
						this.Add ("sqrt", new StaticFunction ("Sqrt", delegate(object[] ps) {
								return Math.Sqrt (Convert.ToDouble (ps [0]));
						}, 1, 1));
						this.Add ("trunc", new StaticFunction ("Trunc", delegate(object[] ps) {
								return Math.Truncate (Convert.ToDouble (ps [0]));
						}, 1, 1));
						...
						//boolean functions
						this.Add ("not", new StaticFunction ("Not", delegate(object[] ps) {
								return !Convert.ToBoolean (ps [0]);
						}, 1, 1));
						this.Add ("if", new StaticFunction ("If", delegate(object[] ps) {
								return Convert.ToBoolean (ps [0]) ? ps [1] : ps [2];
						}, 3, 3));
						this.Add ("and", new StaticFunction ("And", delegate(object[] ps) {
								return Convert.ToBoolean (ps [0]) && Convert.ToBoolean (ps [1]);
						}, 2, 2));
						this.Add ("or", new StaticFunction ("Or", delegate(object[] ps) {
								return Convert.ToBoolean (ps [0]) || Convert.ToBoolean (ps [1]);
						}, 2, 2));
						...
						this.Add ("hex", new StaticFunction ("Hex", delegate(object[] ps) {
								return String.Format ("0x{0:X}", Convert.ToInt32 (ps [0].ToString ()));
						}, 1, 1));
						this.Add ("format", new StaticFunction ("Format", delegate(object[] ps) {
								return string.Format (ps [0].ToString (), ps [1]);
						}, 2, 2));
						this.Add ("len", new StaticFunction ("Len", delegate(object[] ps) {
								return Convert.ToDouble (ps [0].ToString ().Length);
						}, 1, 1));
						this.Add ("lower", new StaticFunction ("Lower", delegate(object[] ps) {
								return ps [0].ToString ().ToLowerInvariant ();
						}, 1, 1));
						this.Add ("upper", new StaticFunction ("Upper", delegate(object[] ps) {
								return ps [0].ToString ().ToUpperInvariant ();
						}, 1, 1));
						this.Add ("val", new StaticFunction ("Val", delegate(object[] ps) {
								return Convert.ToDouble (ps [0]);
						}, 1, 1));
